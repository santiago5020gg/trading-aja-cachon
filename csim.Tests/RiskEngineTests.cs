...
namespace CSimulator.Tests
{
    public class RiskEngineTests
    {
        ...
        {
            // rango=95, ColchonStop=5, riesgo1Micro=(95+5)*2=200
            // PerdidaMaxDiaria=400, MaxTrades=2
            ...
            BuildRango(h, 20000, 20047.5, 19952.5); // range=95
            ...
            h.OrderEngine.Reset();
            var t2 = new DateTime(2026, 1, 15, 9, 42, 0);
            h.NewBar(t2, 20047.5, 20050, 20047, 20048);
        ...
        public void Con1a2_With3Contracts_SplitsCorrectly()
        {
            ...
            // rango=95 -> riesgo=(95+5)*2=200, presupuesto=600/2=300, contratos=floor(300/200)=1... no
            // rango=45 -> riesgo=(45+5)*2=100, presupuesto=600/2=300, contratos=floor(300/100)=3 ✓
            BuildRango(h, 20000, 20022.5, 19977.5); // range=45
            ...
            h.OrderEngine.Reset();
            var t2 = new DateTime(2026, 1, 15, 9, 42, 0);
            h.NewBar(t2, 20022.5, 20025, 20022, 20023);
        ...
        public void Con1a2_With2Contracts_Splits1and1()
        {
            ...
            // rango=95 -> riesgo=(95+5)*2=200, presupuesto=400/2=200, contratos=floor(200/200)=1... no
            // rango=45 -> riesgo=(45+5)*2=100, presupuesto=400/2=200, contratos=floor(200/100)=2 ✓
            BuildRango(h, 20000, 20022.5, 19977.5); // range=45
        ...
        public void Con1a2_With1Contract_AllGoesToTP2()
        {
            ...
            // rango=95 -> riesgo=(95+5)*2=200, presupuesto=400/2=200, contratos=floor(200/200)=1
            // Con1a2 with 1 contract -> qtyTP1=0, qtyTP2=1
            BuildRango(h, 20000, 20047.5, 19952.5); // range=95
