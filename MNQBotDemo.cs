...
{
    public class MNQBotDemo : Strategy
    {
        ...
        private string botHistoryDir = @"C:\Users\santiago.burgos\OneDrive - Perficient, Inc\Documents\perficient\AI path lean\trading 7\bot-demo\history";
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description = "MNQ Bot Demo — Scoring probabilistico con SMA20/SMA200, trailing bar-a-bar";
                Name = "MNQBotDemo";
